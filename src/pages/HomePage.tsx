  ...
  return (
    <div className="space-y-10">
      <section className="rounded-[2rem] border border-brand-line bg-white p-8 shadow-card sm:p-10">
        ...
        <h1 className="mt-3 text-balance text-3xl font-semibold tracking-tight text-brand-ink sm:text-4xl">
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        <Card>
          <p className="text-sm font-semibold text-brand-ink">Customer portal</p>
          <p className="mt-2 text-sm leading-relaxed text-slate-600">
            Order lookup, sign-in, and service wizards are stubbed for navigation and layout.
          </p>
          <div className="mt-4">
            <Link to="/service" className="text-sm font-semibold text-teal-800 hover:underline">
              Open /service
            </Link>
          </div>
        </Card>
        ...
        <Card>
          <p className="text-sm font-semibold text-brand-ink">Admin preview</p>
          <p className="mt-2 text-sm leading-relaxed text-slate-600">
            A separate chrome with sidebar links—still mock-only, no integrations.
          </p>
          <div className="mt-4">
            <Link to="/admin" className="text-sm font-semibold text-teal-800 hover:underline">
              Open /admin
            </Link>
          </div>
        </Card>
